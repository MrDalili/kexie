		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<form id="myform" action="${pageContext.request.contextPath}/CartServlet">
						<div class="col-md-6">
							...
							<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
								...
								<div style="margin:20px 0 10px 0;;text-align: center;">
									...
									<a href="javascript:void(0)">
										<input id="addCartItem" style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button">
									</a >
										<a href="${pageContext.request.contextPath}/admin/web/login.jsp">&nbsp;收藏商品</a> </div>
							</div>
						</div>
					</form>
				</div>
